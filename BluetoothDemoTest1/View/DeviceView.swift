...
struct DeviceView: View {
    ...
    var body: some View {
        NavigationView{
            List(self.binding.deviceArray.wrappedValue, id: \.self){
                device in
            ...
            .alert(item: self.binding.error){
                error in
                Alert(title: Text("Notice"), message: Text(error.localizedDescription))
            }
